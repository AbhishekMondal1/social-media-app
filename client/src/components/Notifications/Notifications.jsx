    ...
    <div className="notification-container">
      <div>
        <Link to={`/profile/${notification.sender?._id}`}>
          <img className="sender-avatar" src={notification?.sender?.pic} alt="useravatar" width={"100px"} />
        </Link>
      </div>
      ...
      {notification.notificationType === "like" && (
        <div>
          <Link to={`/post/${notification.link}`}>
            <img className="notification-media" src={notification?.post[0]?.photo} alt="media" width={"100px"} />
          </Link>
        </div>
      )}
      {notification.notificationType == "follow" ?
